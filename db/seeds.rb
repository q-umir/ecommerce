...
category2.save
category3 = Category.find_or_initialize_by(name: 'pescado')
category3.save

product1 = Product.find_or_initialize_by(title: 'espárragos',
...
product1.save
product2 = Product.find_or_initialize_by(title: 'blackberries',
...
product2.save
product3 = Product.find_or_initialize_by(title: 'brocoli',
...
product5 = Product.find_or_initialize_by(title: 'manzana',
            ...
            description: 'Quot semper vivendo ad vix, qui ad diam lucilius repudiare. Autem voluptua ius id. Invenire antiopam qualisque ne per, ei vim legimus accusam, tale nulla vim ut', category: category2)
product5.save
product6 = Product.find_or_initialize_by(title: 'pimentón',
            code: '022', price: 2, stock: 37,
            description: 'Quot semper vivendo ad vix, qui ad diam lucilius repudiare. Autem voluptua ius id. Invenire antiopam qualisque ne per, ei vim legimus accusam, tale nulla vim ut', category: category1)
product6.save
product7 = Product.find_or_initialize_by(title: 'arándano',
...
product8 = Product.find_or_initialize_by(title: 'kiwi',
            ...
            description: 'Quot semper vivendo ad vix, qui ad diam lucilius repudiare. Autem voluptua ius id. Invenire antiopam qualisque ne per, ei vim legimus accusam, tale nulla vim ut', category: category2)
product8.save
product9 = Product.find_or_initialize_by(title: 'calabacín',
            code: '033', price: 4, stock: 13,
            description: 'Quot semper vivendo ad vix, qui ad diam lucilius repudiare. Autem voluptua ius id. Invenire antiopam qualisque ne per, ei vim legimus accusam, tale nulla vim ut', category: category1)
product9.save
product10 = Product.find_or_initialize_by(title: 'higo',
